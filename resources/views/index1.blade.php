...
<head>
    ...
    <link rel="stylesheet" type="map"      href="assets/css/bootstrap.css.map">
    <link rel="stylesheet" type="map"      href="assets/css/bootstrap.min.css.map">
    <link rel="stylesheet" type="text/css" href="assets/css/bootstrap-grid.css">
    <link rel="stylesheet" type="map"      href="assets/css/bootstrap-grid.css.map">
    <link rel="stylesheet" type="text/css" href="assets/css/bootstrap-grid.min.css">
    <link rel="stylesheet" type="map"      href="assets/css/bootstrap-grid.min.css.map">
    <link rel="stylesheet" type="text/css" href="assets/css/bootstrap-reboot.css">
    <link rel="stylesheet" type="map"      href="assets/css/bootstrap-reboot.css.map">
    <link rel="stylesheet" type="text/css" href="assets/css/bootstrap-reboot.min.css">
    <link rel="stylesheet" type="map"      href="assets/css/bootstrap-reboot.min.css.map">
    <link rel="stylesheet" type="text/css" href="assets/css/style.css">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-xl-3 col-lg-3">
                                    <div class="header-action header-action-flex">
                                        ...
                                        <div class="same-style-2 same-style-2-white same-style-2-hover-black same-style-2-font-inc">
                                            <a href="/login"><i class="icon-heart"></i><span class="pro-count black">03</span></a>
                                        </div>
                        ...
                        <div class="mobile-menu-wrap mobile-header-padding-border-2">
                            ...
                            <nav>
                                <ul class="mobile-menu">
                                    ...
                                    <li class="menu-item-has-children "><a href="/login">Categories</a>
                                        <ul class="dropdown">
                                            <li class="menu-item-has-children"><a href="#">shop layout</a>
                                                ...
                                                <option>Alat Pertukangan</option>
                                                <option>Olahraga</option>
                                                    <li><a href="/login">Alat Musik</a></li>
                                                    <li><a href="/login">Cosplay</a></li>
                                                    <li><a href="/login">Olahraga</a></li>
                                                    <li><a href="/login">Alat Pertukangan</a></li>
                                                    <li><a href="/login">Rumah Tangga</a></li>
                                                </ul>
                                            </li>
